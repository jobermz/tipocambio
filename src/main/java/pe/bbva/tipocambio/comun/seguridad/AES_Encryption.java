...
public class AES_Encryption implements Serializable {

    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final String secretKeyAES = "redeban256";
    private static final String saltAES = "redeban256two";
